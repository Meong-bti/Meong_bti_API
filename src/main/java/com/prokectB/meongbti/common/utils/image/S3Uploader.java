package com.prokectB.meongbti.common.utils.image;
import com.amazonaws.services.s3.AmazonS3Client;
import com.amazonaws.services.s3.model.CannedAccessControlList;
import com.amazonaws.services.s3.model.PutObjectRequest;
import com.prokectB.meongbti.common.exception.unauthorized.ImageConvertFileException;
...
public class S3Uploader {
    ...
    public String getImageUrl(MultipartFile multipartFile, String dirName) throws IOException {
        File file = convertImageFile(multipartFile).orElseThrow(ImageConvertFileException::new);
