...
public class QPostLike extends EntityPathBase<PostLike> {
    ...
    private static final long serialVersionUID = -352107990L;
    ...
    public final com.prokectB.meongbti.member.entity.QMember member;
    ...
    public QPostLike(Class<? extends PostLike> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new com.prokectB.meongbti.member.entity.QMember(forProperty("member")) : null;
